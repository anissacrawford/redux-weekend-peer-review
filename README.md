...
- Server code:   
  - [NA] Router made for GET
  - [x] Router made for POST
...
| User is notified when trying to leave a blank score | yes, not an option |
...
This looks great! 
You hit all of the base mode requirements and some of the stretch goals. 
Your MUI styling looks awesome - the radio buttons are a great touch.  